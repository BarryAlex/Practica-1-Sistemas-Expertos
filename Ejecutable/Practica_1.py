#Edwing Alexis Casillas Valencia. 19110113. 6E6.
import os
import msvcrt
import random
...
while ciclo == 1:
    ...
    #weap_R = random.randrange(0,5)

    Lugar = ["Jardín", "Biblioteca", "Oficina del decano", "Teatro", "Baño"]
    #place_R = random.randrange(0,5)
...
###############################################################################################
    ...
    if SUS_R==0:
        ...
        elif place_R=="Oficina del decano":
        ...
        if weap_R=="Cuchillo":
            mesaje_a="Una vez en el lugar, " + sospechoso[SUS_R] + " le dijo a Robert Suydam que había leído en un libro de había una forma de obtener un poder que va más allá de la comprensión humana, pero para ello era necesario la sangre un gran amigo. Momentos después, Robert Suydam yacía en el suelo sin vida."
        elif weap_R=="Libro":
            mensaje_a="Una vez en el lugar, " + sospechoso[SUS_R] + " le dijo a Robert Suydam que había leido el Necronomicón, dijo que unos seres se han estado comunicando con él diciendole que le pueden dar un gran conocimiento y poder si liberase a éstas criaturas utilizando el libro y un alma de un ser querido. Una vez obtenida el alma, podría invocar a este mundo a estas criaturas y desatar el caos. Momentos después, Robert Suydam yacía en el suelo sin vida."
        elif weap_R=="Cuerda":
            mensaje_a="Una vez en el lugar, " + sospechoso[SUS_R] + " le dijo a Robert Suydam que muy en el fondo de su ser, sentía envidia de todo lo que había logrado hasta entonces y que la única manera de sentirse mejor sería acabando con la existencia de éste. Momentos después, Robert Suydam yacía en el suelo sin vida."
        elif weap_R=="Veneno":
            mensaje_a="Una vez en el lugar, " + sospechoso[SUS_R] + " le dijo a Robert Suydam que el conocimiento que había alcanzado era muy peligroso como para ponerlo en práctica. Al parecer, Robert Suydam había accedido al conocimiento de los Dioses Primigeneos, lo cual si pusiese en práctica terminaría acabando con la existencia humana si así lo quisiese. " + sospechoso[SUS_R] + " le reveló a Robert Suydam que le había puesto un tipo de veneno en su copa de vino, y que no faltaba mucho para que hiciese efecto. Momentos después, Robert Suydam yacía en el suelo sin vida."
        elif weap_R=="Máscara de piedra":
            mensaje_a="Una vez en el lugar, " + sospechoso[SUS_R] + " le dijo que había estado estudiando una misteriosa máscara de piedra que había encontrado en uno de sus viajes a los lugares más ocultos de México. Le dijo que dicha máscara tenia la propiedad de darle vida eterna a una persona si se la ponía. Robert quedó anonadado ante tal afirmación, momentos después " + sospechoso[SUS_R] + " procedió a colocarse la máscara de piedra, casi al instante de la máscara salieron unas grotescas garras que se aferraron al craneo de su usuario, y del frente salió una protuberancia lo suficientemente larga y punsante, que atravezó el cuerpo de Robert Suydam. Al parecer la máscara necesitaba de un sacrificio para funcionar, cosa que no le contó " + sospechoso[SUS_R] + " a obert Suydam. Momentos después, Robert Suydam yacía en el suelo sin vida."

        print("Al parecer " + sospechoso[SUS_R] + " engañó a Robert Suydam para que lo siguiera a " + mensaje_l + " " + mensaje_a)
